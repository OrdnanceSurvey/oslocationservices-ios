 ...
 *  When deferring location updates, the desired accuracy is set to `kCLLocationAccuracyBest` and distanceFilter to `kCLDistanceFilterNone`. They are set back to previous values once the updates are deferred.
