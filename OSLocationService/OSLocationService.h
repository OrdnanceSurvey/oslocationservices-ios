 ...
 *  When deferring location updates, the desired accuracy is set to `kOSLocationAccuracyBest` and distanceFilter to `kOSDistanceFilterNone`. They are set back to previous values once the updates are deferred.
 ...
 */
- (void)allowDeferredLocationUpdatesUntilTraveled:(OSLocationDistance)distance
